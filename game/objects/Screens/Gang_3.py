...
def Gang_3(screen: pygame.Surface, clock: pygame.time.Clock):
    pygame.init()
    ...
    while True:
        ...
        player.update_and_draw(gv.SCREEN_WIDTH - 280, gv.SCREEN_WIDTH / 2 / 2 - 100,
